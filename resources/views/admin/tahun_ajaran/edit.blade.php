...
@section('page_title', 'Edit Tahun Ajaran') {{-- Menambahkan page_title untuk konsistensi --}}
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary shadow">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit mr-1"></i> Form Edit Tahun Ajaran
                    </h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.tahun-ajaran.update', $tahunAjaran->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="tahun" name="nama" value="{{ old('nama', $tahunAjaran->nama) }}" required placeholder="Contoh: 2023/2024">
                            @error('nama')
