...
@push('styles')
    ...
    <style>
        ...
        .btn-success {
            background: linear-gradient(45deg, #28a745, #1d953a);
            border: none;
            border-radius: 8px;
        ...
        .btn-success:hover {
            ...
            background: linear-gradient(45deg, #1d953a, #28a745);
        }
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-user-plus mr-1"></i> Form Tambah Akun Guru Baru
                    </h3>
                </div>
                <form action="{{ route('admin.guru-management.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukkan nama guru" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Masukkan NIP guru" value="{{ old('nip') }}" required>
                                @error('nip')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="kategori" id="kategori" class="form-control @error('kategori') is-invalid @enderror" required>
                                    ...
                                    <option value="PNS" {{ old('kategori') == 'PNS' ? 'selected' : '' }}>PNS</option>
                                    <option value="Non-PNS" {{ old('kategori') == 'Non-PNS' ? 'selected' : '' }}>Non-PNS</option>
                                </select>
                                @error('kategori')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukkan email guru (jika ada)" value="{{ old('email') }}">
                                @error('email')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-save mr-1"></i> Simpan Akun Guru
                        </button>
                    </div>
                </form>
            </div>
