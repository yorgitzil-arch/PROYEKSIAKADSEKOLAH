        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-outline card-warning shadow">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit mr-1"></i> Form Edit Kelas: <span class="font-weight-bold">{{ $kela->nama_kelas }}</span>
                    </h3>
                </div>
                <form action="{{ route('admin.kelas.update', $kela->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nama_kelas" class="form-control @error('nama_kelas') is-invalid @enderror" id="nama_kelas" placeholder="Masukkan nama kelas" value="{{ old('nama_kelas', $kela->nama_kelas) }}" required>
                                @error('nama_kelas')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="tingkat" class="form-control @error('tingkat') is-invalid @enderror" id="tingkat" placeholder="Masukkan tingkat (contoh: X, XI, XII)" value="{{ old('tingkat', $kela->tingkat) }}" required>
                                @error('tingkat')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <select name="wali_kelas_id" id="wali_kelas_id" class="form-control select2bs4 @error('wali_kelas_id') is-invalid @enderror" style="width: 100%;">
                                    ...
                                    @foreach ($gurus as $guru)
                                        <option value="{{ $guru->id }}" {{ old('wali_kelas_id', $kela->wali_kelas_id) == $guru->id ? 'selected' : '' }}>{{ $guru->name }}</option>
                                    @endforeach
                                </select>
                                @error('wali_kelas_id')
                                <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-warning float-right ml-2">
                            <i class="fas fa-sync-alt mr-1"></i> Perbarui Kelas
                        </button>
