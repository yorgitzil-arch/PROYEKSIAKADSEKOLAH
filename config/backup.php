    ...
    return [
        ...
        'backup' => [
             ...
             * the backups.
             */
            'name' => env('APP_NAME', 'aplikasismkn1'), // Menggunakan APP_NAME dari .env
            ...
            'source' => [
                'files' => [
                    ...
                    'exclude' => [
                        ...
                        storage_path('app/backups'), // Jangan backup folder backups itu sendiri
                    ],
            ...
            'destination' => [
                 ...
                 */
                'filename_prefix' => env('APP_NAME') . '-', // Menggunakan APP_NAME dari .env

                /*
                 * The disk names on which the backups will be stored.
                 */
                'disks' => [
                    'google', // <--- HANYA DISK 'LOCAL' DI SINI!
                ],
            ],
        ...
        \Spatie\Backup\Notifications\Notifications\CleanupHasFailed::class,
            ...
            'mail' => [
                'to' => 'yordinatal.putra.e@mail.ukrim.ac.id',
